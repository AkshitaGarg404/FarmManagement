...
const LoginPage = () => {
    const [email, setEmail] = useState(""); //email is an object that is initiatlly "" (from useState) and setEmail is a function used to modify this value
    ...
    return (
        <div  className='flex flex-col justify-center py-12 sm:px-6 lg:px-8'>
            <motion.div 
                ...
                initial={{ opacity: 0, y: -20  }} //initially hidden and slightly at top
                animate={{ opacity: 1, y: 0 }} //at end becomes solid and comes down //takes 8 seconds to do so
